...
urlpatterns = [
    ...
    path(
        "<str:inschrijving_id>/attest/download",
        views.inschrijvingen_attest_download,
        name="inschrijving_attest_download",
    ),
    path(
        "<str:inschrijving_id>/attest/mail",
        views.inschrijvingen_attest_mail,
        name="inschrijving_attest_mail",
    ),
]
