...
urlpatterns = [
    ...
    path(
        "docs/", serve, {"document_root": settings.BASE_DIR / ".." / "docs", "path": "README.md"}
    ),  # README te vinden via docs/
    path(
        "docs/<path:path>", serve, {"document_root": settings.BASE_DIR / ".." / "docs"}
    ),  # technische documentatie terug te vinden via /docs/<naam>
