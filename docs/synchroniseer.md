...
Het doet dit door gebruik te maken van Django modellen te vinden in [src/inschrijfbeheer/models.py](../src/inschrijfbeheer/models/). De data wordt ingeladen vanuit de oude Integreat databank en vervolgens door de mapper-functies omgezet naar nieuwe objecten voor in de nieuwe databank.
